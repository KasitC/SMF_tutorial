...
Now, it's time to assign promoter states to bin patterns.
```{r}
PromoterStates <- list(unassigned = c("0101", "0110", "1010"),
...
# Working on the DMSO sample
DMSO_df <- StateFrequency_tbl %>% filter(Sample == "DMSO_DE_S2")
DMSO_df
